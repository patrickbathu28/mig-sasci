...
class SasciController (val sasciClient: SasciClient,
    ...
    @PostMapping("/v1/cidadao/pf", produces= [MediaType.APPLICATION_JSON_VALUE])
    ...
    @PostMapping("/v1/cidadao/pj", produces= [MediaType.APPLICATION_JSON_VALUE])
    ...
    @PutMapping("/v1/cidadao/{id}", produces= [MediaType.APPLICATION_JSON_VALUE])
    ...
    @DeleteMapping("/v1/cidadao/{id}", produces= [MediaType.APPLICATION_JSON_VALUE])
